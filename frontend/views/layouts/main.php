...
<!DOCTYPE html>
	...
	<?php
			//---MENU SIDE--
			 $menuItems=[
									['label' => Icon::show('home').'Baranda', 'url' => ['/site']],
									['label' => Icon::show('home').'Dokumentasi', 'url' => ['/doc']],
									['label' => Icon::show('home').'Akun', 'items' => [
											['label' => 'FAQ', 'url' => ['/faq']],										
...
<body class="hold-transition skin-blue">
    <?php $this->beginBody() ?>
		<div style="height:100px; background:pink">
			<div class="container"> <h1> API - DEVELOP </h1> </div>
		</div>
